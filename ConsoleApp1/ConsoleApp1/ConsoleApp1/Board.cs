...
namespace ConsoleApp1
{
    class Board
    {
        ...
        public Board()
        {
            ...
            subMarines.Add(new SubMarine(Type.subMarine4));
            subMarines.Add(new SubMarine(Type.subMarine3));
            subMarines.Add(new SubMarine(Type.subMarine2));
            subMarines.Add(new SubMarine(Type.subMarine1));
